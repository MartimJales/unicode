...
void convert_c(struct stack *ptr_STACK)
{
    ...
    case T_int:
        val.tipo = T_char;
        val.data.val_c = abs((int)val.data.val_i);
        break;
    case T_float:
        val.tipo = T_char;
        val.data.val_c = abs((int)val.data.val_f);
        break;
    case T_double:
        val.tipo = T_char;
        val.data.val_c = abs((int)val.data.val_d);
        break;
    case T_long:
        val.tipo = T_char;
...
void convert_s(struct stack *ptr_STACK)
{
    ...
    case T_int:
        val.tipo = T_string;
        sprintf(resultado.data.val_s, "%d", val.data.val_i);
        break;
    case T_float:
        val.tipo = T_string;
        sprintf(resultado.data.val_s, "%.6g", val.data.val_f);
        break;
    case T_double:
        val.tipo = T_string;
        sprintf(resultado.data.val_s, "%.6g", val.data.val_d);
        break;
    case T_long:
        val.tipo = T_string;
    ...
    case T_char:
        val.tipo = T_string;
        sprintf(resultado.data.val_s, "%c", val.data.val_c);
        break;
    default:
        printf("Deu bagulho na função convert_s\n");
        break;
    }
    PUSH(ptr_STACK, resultado);
}
